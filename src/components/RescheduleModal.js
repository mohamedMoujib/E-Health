...
import { getAvailableSlots  } from "../Redux/slices/appointmentSlice";
import { rescheduleAppointment,fetchAppointmentDetails } from "../Redux/slices/medicalFileSlice";
...
export default function RescheduleModal  ({ appointment, patientId, open, onClose, onSuccess })  {
    ...
    const handleConfirm = () => {
        if (summary) {
          ...
          dispatch(rescheduleAppointment(appointmentData))
            .unwrap()
            .then(() => {
          ...
          >
            <Box display="flex" alignItems="center">
              ...
              <Typography variant="h5" fontWeight="bold">
                {summary ? "Résumé du Rendez-vous" : "Rescheduler un Rendez-vous"}
              </Typography>
            </Box>
